        ...
        >
          ...
          <div className="p-4 space-y-2">
            ...
            <motion.button
              ...
              className="w-full px-4 py-3 bg-slate-700/30 hover:bg-slate-700/50 rounded-lg text-left transition-all border border-slate-600/50 hover:border-yellow-500/50 flex items-center justify-between group"
              whileHover={{ scale: 1.01 }}
              whileTap={tapScale}
            >
